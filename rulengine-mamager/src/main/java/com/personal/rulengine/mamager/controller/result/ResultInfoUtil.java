...
public class ResultInfoUtil {
     ...
     * @return
     */
    public static <T> ResultInfoList<T> setSuccessInfoList(int totalCount, int pageIndex, int pageSize, List<T> items) {
        ResultInfoList<T> resultInfoList=PageListUtil.getPageList(totalCount, pageIndex, pageSize, items);
