package com.personal.rulengine.common.utils;
 ...
 * 
 */
public final class GenericDAOUtils {
    ...
    public static <V extends BaseViewObject<V>, E extends BaseEntity> void transToViewObject(
        ...
        for (BaseEntity entity : entities) {
            ...
            copyProperties(viewObject, entity);
...
//        private static final BooleanConverter BOOLEAN_CONVERTER =  new BooleanConverter();
        ...
        public Converter lookup(Class pClazz) {
            ...
            } /* else if (Boolean.class.isAssignableFrom(pClazz)) {
    ...
    private class BooleanConverter extends AbstractSingleValueConverter{

        private final BooleanConverter TRUE_FALSE = new BooleanConverter("true", "false", false);
        private final BooleanConverter YES_NO = new BooleanConverter("yes", "no", false);
        private final BooleanConverter BINARY = new BooleanConverter("1", "0", true);
